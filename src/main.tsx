...
function App(){
 ...
 <main>{page==="home"&&<Home go={go} openChoice={setChoice}/>} {page==="about"&&<About/>} {page==="services"&&<Services/>} {page==="order"&&<Order/>} {page==="support"&&<Support/>} {page==="inquiry"&&<Inquiry/>} {page==="complaint"&&<Complaint/>} {page==="partner"&&<Partner/>} {page==="join"&&<Join openChoice={setChoice}/>} {page==="contact"&&<Contact openChoice={setChoice}/>} {page==="privacy"&&<Legal title="سياسة الخصوصية" type="privacy"/>} {page==="terms"&&<Legal title="الشروط والأحكام" type="terms"/>}</main>
