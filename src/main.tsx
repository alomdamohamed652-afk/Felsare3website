...
function App(){
 ...
 React.useEffect(()=>{document.title = page === "home" ? "فالسريع | كل اللي محتاجه يوصلك" : `فالسريع | ${{about:"عن فالسريع",services:"خدماتنا",order:"اطلب الآن",support:"الدعم",inquiry:"استفسار",complaint:"تقديم شكوى",partner:"الشراكة",join:"انضم إلينا",contact:"تواصل معنا",privacy:"سياسة الخصوصية",terms:"الشروط والأحكام"}[page]}`;},[page]);
 ...
 <main>{page==="home"&&<Home go={go}/>} {page==="about"&&<About/>} {page==="services"&&<Services/>} {page==="order"&&<Order/>} {page==="support"&&<Support/>} {page==="inquiry"&&<Inquiry/>} {page==="complaint"&&<Complaint/>} {page==="partner"&&<Partner/>} {page==="join"&&<Join/>} {page==="contact"&&<Contact/>} {page==="privacy"&&<Legal title="سياسة الخصوصية" type="privacy"/>} {page==="terms"&&<Legal title="الشروط والأحكام" type="terms"/>}</main>
