...
<section className="cta"><h2>محتاج حاجة؟</h2><p>اختار الطريقة المناسبة وتواصل معنا مباشرة.</p><div className="hero-buttons center-buttons"><a className="btn primary" href={PHONE_HREF}><Phone/> اتصل الآن</a><a className="btn secondary" href={WHATSAPP ? contactHref(WHATSAPP) : "#contact"} target={WHATSAPP ? "_blank" : undefined} rel={WHATSAPP ? "noreferrer" : undefined}><MessageCircle/> واتساب</a></div></section></>}
